# HiredLogics OneClick Extension
...
2. **Get your API key (BD only)**
   ...
   - In the sidebar, click **Copy OneClick API key** (key is copied to clipboard)
...
3. **Configure the extension**
   ...
   - **API Key**: paste the OneClick API key you copied from the BD dashboard
   - Click **Save**
...
- **GET /api/bd/oneclick-token** — (JWT) returns or creates the BD’s OneClick API key for use in the extension.
